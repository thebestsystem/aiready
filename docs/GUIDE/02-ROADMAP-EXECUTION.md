...
| A5 | **Sécurité P1** : anti-SSRF scan, rate-limit lead/report PDF, validation email | commit `bcccb71` | Haute | ✅ Code `main` (16/16 tests, CI verte). ⏳ reste RE-DEPLOIEMENT prod (env attendu) |
