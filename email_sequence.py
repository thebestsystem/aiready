...
SEQUENCE = [
    ...
    },
    {
        ...
        "body": (
            ...
            "<ul>"
            "<li><b>Analyse « Complétude de l'offre »</b> : ce que ChatGPT répond sur vos produits.</li>"
            "<li>Export 1 clic de votre <b>carte d'identité IA</b> (<code>llms.txt</code> & JSON-LD enrichi).</li>"
            "<li><b>1 panier récupéré par mois rembourse 5×</b> votre abonnement.</li>"
            "<li>Alertes email d'intégrité de thème — <b>bientôt</b>.</li>"
            "</ul>"
    ...
    },
    {
        ...
        "body": (
            ...
            "<p>L'essai de 14 jours est <b>gratuit et sans engagement</b> : scanner toutes vos fiches, "
